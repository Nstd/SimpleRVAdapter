...
import com.github.nstd.simple.rvadapter.ConfigListener;
import com.github.nstd.simple.rvadapter.Constants;
import com.github.nstd.simple.rvadapter.SimpleHolderLayout;
import com.github.nstd.simple.rvadapter.SimpleRecyclerViewHolder;
import com.github.nstd.simple.rvadapter.inflater.IHolderInflater;
import com.github.nstd.simple.rvadapter.inflater.InflateResult;
import com.github.nstd.simple.rvadapter.inflater.NormalHolderInflaterImpl;
...
public class SimpleHolderReflector {
    ...
    static {
        ...
        try {
            Class bindingInflater = Class.forName("com.github.nstd.inflater.BindingHolderInflaterImpl");
    ...
    public static SimpleRecyclerViewHolder getHolder(ItemViewTypeInfo holder,
                                                     ViewGroup parent,
        ...
        try {
            Constructor c;
            SimpleRecyclerViewHolder targetHolder = null;
            ...
            if(holder.holderClazz.isMemberClass()) {
                ...
                if(!Modifier.isStatic(modifiers)) {
                    ...
                    targetHolder = (SimpleRecyclerViewHolder) (c.newInstance(holder.outerObject, targetObject));
                } else {
                    c = holder.holderClazz.getConstructor(new Class<?>[]{targetClass});
                    targetHolder = (SimpleRecyclerViewHolder) (c.newInstance(targetObject));
                }
            } else {
                c = holder.holderClazz.getConstructor(new Class<?>[]{targetClass});
                targetHolder = (SimpleRecyclerViewHolder) (c.newInstance(targetObject));
    ...
    public static LayoutInfo getLayoutResId(Class clazz, int layoutResId) {
        ...
        if(layoutResId != Constants.INVALIDATE_LAYOUT_ID) {
            ...
            while(clazz.getAnnotation(SimpleHolderLayout.class) == null && clazz != SimpleRecyclerViewHolder.class) {
        ...
        info.isDataBinding = !SimpleRecyclerViewHolder.class.isAssignableFrom(clazz);
        return info;
    }
